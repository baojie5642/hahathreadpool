...
public class BaojieThreadPool extends AbstractExecutorService {
     ...
     */
    public BaojieThreadPool(int corePoolSize,
            int maximumPoolSize,
            long keepAliveTime,
            TimeUnit unit,
    ...
    public static class CallerRunsPolicy extends BaojieRejectedHandler {
        ...
        public void rejectedExecution(Runnable r, BaojieThreadPool e) {
            if (!e.isShutdown()) {
                r.run();
            }
        }
