package com.baojie.zk.example.random;
...
public class SecurityRandom {
    private static final Logger log = LoggerFactory.getLogger(SecurityRandom.class);

    // copy from:
    // https://
    // github.com/lealone/Lealone/blob/master/lealone-common/src/main/java/org/lealone/common/util/MathUtils.java
    ...
    static void warn(String s, Throwable t) {
        if (null != t) {
            log.error("info=" + s + ",error=" + t.toString(), t);
        }
