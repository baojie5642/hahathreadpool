...
public enum JavaVersion {
     ...
     */
    public final boolean atLeast(final JavaVersion requiredVersion) {
    ...
    public static final JavaVersion getJavaVersion(final String nom) {
        return get(nom);
    }
     ...
     * version is unknown
     */
    public static final JavaVersion get(final String nom) {
        if ("0.9".equals(nom)) {
            return JAVA_0_9;
    ...
    /**
     * Gets the Java Version from the system or 99.0 if the {@code java.specification.version} system property is not
     * set.
     *
     ...
     */
    private static final float toFloatVersion(final String value) {
    ...
    private static final float toFloat(final String str, final float defaultValue) {
        if (str == null) {
            return defaultValue;
        }
        try {
